    ...
    <div class="row">
      <div class="col-xs-12 col-sm-4">
        <div class="product-preview">
          <div class="push-down-20">
            <img class="js--product-preview" alt="Single product image" src="images/food-1.jpg" width="360" height="458">
          </div>
      ...
      <div class="col-xs-12 col-sm-8">
        <div class="products__content">
          ...
          <h1 class="single-product__title"><span class="light"></span> Lamb Adobo Recipe</h1>
