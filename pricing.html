...
<div class="container  push-down-30">
  <div class="row">
    <div class="col-xs-12">
      <h1 class="center"><span class="light">Pricing</span> Tables</h1>
      <hr class="divider">
      ...
      <div class="row">
        ...
        <div class="col-xs-12  col-sm-12  push-down-30">
          <table class="table table-theme table-striped">
            ...
            <tbody>
              <tr>
                <td><a class="secondary-link" href="#">Base Brine for Fermented Vegetables</a></td>
                <td>Veg</td>
                <td class="right">$15.00</td>
              </tr>
              <tr>
                <td>Mashrooms & Fungus</td>
                <td>Veg</td>
                <td class="right">Coming soon</td>
              </tr>
              <tr>
                <td><a class="secondary-link" href="http://themeforest.net/item/webmarket-html-template-for-online-shop/5409539?ref=proteusthemes" target="_blank">Spicy Ribs (Tskhare Neknebi)</a></td>
                <td>Non-Veg</td>
                <td class="right">$15.00</td>
              </tr>
              <tr>
                <td><a class="secondary-link" href="http://themeforest.net/item/webmarket-wp-woocommerce-theme-for-online-shop/6437728?ref=proteusthemes" target="_blank">Red Ajika </a></td>
                <td>Veg</td>
                <td class="right">$35.00</td>
              </tr>
              <tr>
                <td><a class="secondary-link" href="http://themeforest.net/item/webmarket-magento-theme-for-online-shop/6382713?ref=proteusthemes" target="_blank">Spanish Vermicelli Noodles with Prawns, Cockles, and Squid </a></td>
                <td>Veg</td>
                <td class="right">$30.00</td>
              </tr>
              <tr>
                <td><a class="secondary-link" href="http://themeforest.net/item/hairpress-html-template-for-hair-salons/3803346?ref=proteusthemes" target="_blank">Spicy Creole Pickled Pig’s Trotters</a></td>
                <td>Non-Veg</td>
                <td class="right">$16.00</td>
              </tr>
              <tr>
                <td><a class="secondary-link" href="http://themeforest.net/item/hairpress-wordpress-theme-for-hair-salons/4099496?ref=proteusthemes" target="_blank">Cretan Fried Cheese Pastries (Sarikopitakia)</a></td>
                <td>Veg</td>
