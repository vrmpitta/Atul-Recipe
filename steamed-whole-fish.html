      ...
      <div class="col-xs-12">
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="active">Steamed Whole Fish</li>
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-4">
        <div class="product-preview">
          <div class="push-down-20">
            <img class="js--product-preview" alt="Single product image" src="images/food-2.jpg" width="360" height="458">
          </div>
      ...
      <div class="col-xs-12 col-sm-8">
        <div class="products__content">
          ...
          <h1 class="single-product__title"><span class="light">Steamed Whole Fish</span> with Dried Tangerine Peel and Fennel</h1>
          ...
          <div class="row">
            <div class="col-xs-12  col-sm-6  col-md-4">
              <div class="banners-small  banners-small--social">
                <a href="https://www.facebook.com" class="social"><span class="zocial-facebook"></span>
                Share on<br>
            ...
            <div class="col-xs-12 col-sm-6  col-md-4">
              <div class="banners-small  banners-small--social">
                <a href="https://twitter.com" class="social"><span class="zocial-twitter"></span>
                Tweet it<br>
            ...
            <div class="col-xs-12 col-sm-6  col-md-4">
              <div class="banners-small  banners-small--social">
                <a href="https://www.pinterest.com" class="social"><span class="zocial-pinterest"></span>
                Pin on<br>
