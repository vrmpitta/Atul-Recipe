...
<header class="header">
  ...
  <div class="collapse  navbar-collapse" id="collapsible-navbar">
    <ul class="nav  navbar-nav">
      ...
      <li class="dropdown">
        <a href="recipe.html" class="dropdown-toggle">RECIPIES</a></li>
...
<div class="container">
  <div class="row">
    <div class="col-xs-12">
      <img alt="#" class="product__image" src="images/banner22.jpg" width="1140" height="284">
      <h1 class="center"><span class="light"></span>   About Us</h1>
      <hr class="divider">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12">
          <h3><span class="light"></span> About us</h3>
          <p class="text"> Times Food is a sustenance and recipes site controlled by Times Group. A meander that spotlights on customer made substance, chronicles, articles and equations from wherever all through the world, Times Food passes on the legacy of The Times of India in substance and quality. The site has more than 7000 equations with all the all the more being incorporated step by step. It is a one stop objective for every foodie who is hunting down latest sustenance news, recipes in light of various cooking styles, dietary needs, fixings, occasions and arrangements and chronicles flooding with attracting content. <p>
        <p class="text">Barely multi year old, Times Food starting at now has a consistently readership of in excess of 1 million which is reliably broadening. From all around requested equations to apparently captivating pictures, Times sustenance has everything a foodie is hunting down. Features on latest sustenance designs, sustenance news, kitchen hacks and tips and chronicles that make equations straightforward despite for someone who isn't an ace in the kitchen, impact this site to rise. In light of calorie incorporate, time taken setting up a dish, fixings and dietary essentials, you can impact your own specific eating regimen to chart or week after week menu outline.<p>
          <h3><span class="light"></span> </h3>
          <p class="text">Anyone can transform into a blogger with Times Food by making a profile and exchanging equations and it is free! Moreover, it has a massive storage facility of blogger and culinary master equations. Available on both Android <p>
        </div>
